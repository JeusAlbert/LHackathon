            ...
            <div class="row">
                ...
                <form action="/action_page.php">
                    ...
                    <div id="collapseOne" class="collapse show" data-parent="#accordion">
                        <div class="card-body">
                        It saves a portion of a barangay from sewege clogging.
                        </div>
                    </div>
                    </div>
                    <div class="card">
                    ...
                    <div id="collapseTwo" class="collapse" data-parent="#accordion">
                        <div class="card-body">
                        You can contribute in environmental textbooks to public schools.
                        </div>
                    </div>
                    </div>
                    <div class="card">
                    ...
                    <div id="collapseThree" class="collapse" data-parent="#accordion">
                        <div class="card-body">
                        You can donate to our local farmers.
                        </div>
                    </div>
                    </div>
                    </div>
                    <div class="card">
                            ...
                            <div id="collapseThree" class="collapse" data-parent="#accordion">
                                <div class="card-body">
                                    You can fund the green go company who supports recycled materials.
                                </div>
                            </div>
                            </div>
                            </div>
                            <div class="card">
                                    ...
                                    <div id="collapseThree" class="collapse" data-parent="#accordion">
                                        <div class="card-body">
                                        You can donate in one of the big charities that helps the environment
                                        </div>
                                    </div>
                                    </div>
                                    </div>
